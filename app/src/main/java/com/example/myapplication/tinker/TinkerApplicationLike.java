package com.example.myapplication.tinker;
...
import com.example.myapplication.tinker.Log.MyLogImp;
import com.example.myapplication.tinker.utils.TinkerManager;
...
@DefaultLifeCycle(application = "com.example.myapplication.MyApplication",// application类名。只能用字符串，这个MyApplication文件是不存在的，但可以在AndroidManifest.xml的application标签上使用（name）
